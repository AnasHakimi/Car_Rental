...
import com.example.carrental.AdminBookingDetailActivity;
...
public class AdminBookingAdapter extends RecyclerView.Adapter<AdminBookingAdapter.BookingViewHolder> {
    ...
    public AdminBookingAdapter(List<Booking> bookingList, CarAdapter carAdapter, Context context) {
    ...
    public BookingViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adminbooking_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull BookingViewHolder holder, int position) {
        ...
        if ("New".equals(booking.getBooking_status())) {
            holder.viewUpdateButton.setVisibility(View.VISIBLE);
        } else {
            holder.viewUpdateButton.setVisibility(View.GONE);
        }
        //update button
        holder.viewUpdateButton.setOnClickListener(v -> {
            Intent intent = new Intent(context, AdminBookingDetailActivity.class);
    ...
    public static class BookingViewHolder extends RecyclerView.ViewHolder {
        ...
        public BookingViewHolder(@NonNull View itemView) {
            ...
            viewUpdateButton = itemView.findViewById(R.id.viewUpdateButton);
        }
